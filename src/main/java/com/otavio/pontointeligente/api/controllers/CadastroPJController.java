...
import com.otavio.pontointeligente.api.dtos.CadastroPJDto;
...
//aceitar requisições de diversos lugares - ideal é colocar a url do local
@CrossOrigin(origins = "*")
public class CadastroPJController {
	...
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto,
			//binding result traz o resultado da validacao
			//nosuch é sobre a geração de senha
